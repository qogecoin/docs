Qogecoin Core version 0.13.2 is now available from:
  ...
  <https://download.qogecoin.org/qogecoin-0.13.2.1/>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/qogecoin-project/qogecoin/issues>
...
Qogecoin Core 0.13.2 will have a strict maximum size on the mempool. The
...
Qogecoin Core 0.13.2 also introduces new default policy limits on the length and
...
- `qogecoin-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries for the most
  common 32-bit ARM architecture.
- `qogecoin-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries for the most
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  currently being researched by Bitcoin and Qogecoin Core contributors that may
...
segwit's start date of 1 January 2017 miners can update the Qogecoin
client to Qogecoin Core 0.13.2 to signal for segwit support. When a
